...
var estar, onestar, twostar; 
var score;

var star, star2, starI;
...
function setup() 
{
  ...
  score.scale = 0.2
  score.addAnimation('empty', estar);
  score.addAnimation('one', onestar);
  score.addAnimation('two', twostar);
